...
extern float Mouse_X_UPDATA, Mouse_Y_UPDATA, Mouse_Z_UPDATA;
extern float Mouse_X_Last, Mouse_Y_Last, Mouse_Z_Last;

void rc_sensor_init(rc_sensor_t *rc_sensor);
void rc_sensor_update(rc_sensor_t *rc_sensor , uint8_t *rxBuf);
extern void rc_sensor_heart_beat(rc_sensor_t *rc);

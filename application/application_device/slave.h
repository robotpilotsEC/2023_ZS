...
{	
	...
	uint16_t shooter_id1_17mm_shooting_heat;	
	
} slave_pack1_t; 

typedef __packed struct
{
	uint16_t shooter_id1_17mm_shooting_limit;
...
typedef __packed struct
{
	uint16_t shooter_id2_17mm_shooting_heat;		
	uint16_t shooter_id2_17mm_shooting_limit;	
